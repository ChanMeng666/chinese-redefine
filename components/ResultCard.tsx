        ...
        <Card className="mt-6 sm:mt-8 overflow-hidden bg-white">
            <CardContent className="p-4 sm:p-6 space-y-4">
                ...
                {(pinyin || english || japanese) && (
                    <motion.div
                        className="flex flex-wrap gap-x-4 gap-y-1 text-sm text-slate-500"
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
                        transition={{ delay: 0.25 }}
                    >
                        {pinyin && <span>{pinyin}</span>}
                        {english && <span className="italic">{english}</span>}
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mt-4">
                    ...
                    <div className="flex flex-wrap gap-2 order-1 sm:order-2 w-full sm:w-auto">
                        ...
                        <motion.div
                            ...
                            whileTap="tap"
                        >
                            <DownloadButton word={word} explanation={explanation} pinyin={pinyin} english={english} japanese={japanese}/>
                        </motion.div>
                    </div>
                    ...
                    {showPreview && (
                        ...
                        >
                            <div className="w-full">
                                <SVGPreview word={word} explanation={explanation} pinyin={pinyin} english={english} japanese={japanese}/>
                            </div>
                        </motion.div>
                    )}
                </AnimatePresence>
